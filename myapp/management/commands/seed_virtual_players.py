...
PRIVATE_HIGH_SCHOOLS = [
    '大和学園高校', '明徳館高校', '聖蘭学院高校', '桜丘学園高校', '東邦学院高校',
    '光陽学園高校', '誠英高校', '育英学舎高校', '東湾大学附属高校', '中央国際大学附属高校',
    '北陵学園高校', '西海学院高校', '南央学園高校', '青嵐学院高校', '緑丘学院高校',
    '白鷺学院高校', '甲南学芸大学附属高校', '神楽坂学院高校', '秀明館高校', '弘学館高校',
    '東光学園高校', '白鳳学院高校', '若葉学園高校', '清和学院高校', '三和学園高校',
    '北斗学館高校', '常盤学院高校', '陽明学院高校', '千歳学園高校', '緑陽学院高校',
    '桜陵学園高校', '湾岸学院高校', '北都学園高校', '中京学芸高校', '湾岸工業大学附属高校',
    '北都大学附属高校', '東央学院大学附属高校', '桜丘大学附属高校', '青蘭大学附属高校', '朝日国際学園高校',
    '白翔学園高校', '紫苑学院高校', '常磐学舎高校', '東星学園高校', '誠心学院高校',
    '明和学館高校', '志学館高校', '修英学園高校', '啓文学院高校', '育英館高校',
    '誠明学園高校', '崇明学院高校', '尚志学園高校', '至真学院高校', '慧明学館高校',
    '大成学園高校', '城南学院高校', '城北学園高校', '城翠学館高校', '城東学院高校',
    '千早学園高校', '令和学院高校', '若竹学院高校', '柏葉学園高校', '飛鳥学院高校',
    '桜花学園高校', '嵯峨野学院高校', '相模学園高校', '博多学院高校', '相北学園高校',
    '陽光学院高校', '千寿学園高校', '三葉学院高校', '五陵学園高校', '六稜学園高校',
    '七宝学院高校', '八重洲学園高校', '九曜学院高校', '十善学園高校', '明陽学院高校',
    '光陵学院高校', '誠和学園高校', '泰山学院高校', '陽光大学附属高校', '千歳学芸大学附属高校',
    '博多国際大学附属高校', '白鳳大学附属高校', '飛鳥大学附属高校',
]
...
UNIVERSITIES = [
    ...
    '湾岸工業大学', '北都大学', '東央学院大学', '西陵大学', '中京文理大学',
    '桜丘大学', '常盤大学', '朝日国際大学', '明陽大学', '青蘭大学',
    '相模国際大学', '陽光大学', '千歳学芸大学', '博多国際大学', '若竹大学',
    '白鳳大学', '三和工業大学', '北斎大学', '清和大学', '東雲大学',
    '緑陽大学', '中央文理大学', '湾岸国際大学', '常盤学芸大学', '陽明大学',
    '東光大学', '柏葉大学', '飛鳥大学', '桜花大学', '嵯峨野大学',
    '大和国際大学', '千早大学', '五陵大学', '六稜大学', '七宝大学',
    '八重洲大学', '九曜大学', '十善大学', '相北大学', '城南学芸大学',
    '城北学芸大学', '城翠大学', '城東学芸大学', '泰山大学', '光陵大学',
    '誠和大学', '令和学芸大学', '千寿大学', '三葉大学', '大成大学',
    '白翔大学', '紫苑大学', '常磐学舎大学', '東星大学', '誠心大学',
    '明和学芸大学', '志学館大学', '修英大学', '啓文大学', '育英大学',
    '誠明大学', '崇明大学', '尚志大学', '至真大学', '慧明大学',
    '相模学芸大学', '博多学芸大学', '陽光学芸大学', '湘南国際大学', '房総大学',
    '信濃大学', '甲斐大学', '出雲大学', '備前大学', '隼人大学',
    '陸奥大学', '松浦大学', '有明大学',
]
CORPORATE_TEAMS = [
    '東海重工', '北陸電機', '大和製鋼', '扶桑紡績', '中京運輸',
    '山陽化学', '関東製粉', '九州電子工業', '北都銀行', '太平洋物産',
    '東北製鉄', '北陸重工', '中部電力工業', '山陰紡績', '四国運輸',
    '九州製薬', '関西化学', '東海ガス', '北海道乳業', '東京物産',
    '大阪紙業', '名古屋鉄鋼', '神戸造船', '横浜電子', '京都硝子',
    '福岡製粉', '仙台製菓', '広島タイヤ', '静岡製紙', '岡山紡織',
    '金沢電機', '長野精機', '熊本食品', '札幌乳業', '千葉石油',
    '埼玉証券', '群馬生命', '栃木損保', '茨城飲料', '三重ゴム',
]
...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            '--refresh-schools', action='store_true',
            help=(
                'このコマンドで過去に投入した架空の日本人選手（助っ人を除く）の'
    ...
    def _refresh_schools(self, *, dry_run):
        ...
        for player in targets:
            high_school, university, corporate_team, _debut_age = make_amateur_career(
                False, player.birthplace
            )
        ...
        if not dry_run:
            with transaction.atomic():
                Player.objects.bulk_update(
                    to_update, ['high_school', 'university', 'corporate_team'], batch_size=500
                )

        prefix = '[dry-run] ' if dry_run else ''
        self.stdout.write(self.style.SUCCESS(
            f"{prefix}選手 {len(to_update)}人の出身高校・大学・社会人チームを選び直しました"
        ))
