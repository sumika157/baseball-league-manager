...
class RosterOrderingTest(TestCase):
    ...
    def test_pitchers_are_sorted_by_era(self):
        ...
        bad.record_pitching(PitchingLine(innings=InningsPitched.from_notation("9.0"), earned_runs=9))
        good.record_pitching(PitchingLine(innings=InningsPitched.from_notation("9.0"), earned_runs=1))
    ...
    def test_pitchers_without_innings_go_last(self):
        ...
        pitched.record_pitching(PitchingLine(innings=InningsPitched.from_notation("9.0"), earned_runs=3))
    ...
    def test_batters_and_pitchers_are_separated(self):
        ...
        self.assertEqual(sorted(p.name for p in team.batters_by_ops()), ["DH", "野手"])
