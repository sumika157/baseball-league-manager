...
class StadiumHomeTeamAssignmentTest(BaseCase):
    ...
    def _save(self, team_ids, **overrides):
        payload = {
            'name': self.dome.name, 'city': '', 'capacity': '',
            'surface': '', 'roof': '', 'opened_year': '',
...
class StadiumRoofTest(BaseCase):
    ...
    def test_roof_is_saved(self):
        response = self.client.post('/admin/myapp/stadium/add/', {
            'name': '屋根つき球場', 'city': '', 'capacity': '',
            'surface': '', 'roof': 'ドーム', 'opened_year': '', 'home_teams': [],
        })
    ...
    def test_unknown_roof_is_rejected(self):
        response = self.client.post('/admin/myapp/stadium/add/', {
            'name': 'ガラス球場', 'city': '', 'capacity': '',
            'surface': '', 'roof': 'ガラス張り', 'opened_year': '', 'home_teams': [],
        })
